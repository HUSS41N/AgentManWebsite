    ...
    return (
        <div id="projects">
            ...
            <motion.p
                ...
                whileInView={{ y: 0, opacity: 1 }}
                transition={{ duration: 1 }}
                className="text-center tracking-wider text-xl mt-2"
            >
                See What Awaits You
            </motion.p>
            <div className="py-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4 mx-auto px-8">
                <Card
                    title="Create Lightning-Fast Agents with Ease"
                    icon={<AceternityIcon />}
                >
                    <CanvasRevealEffect
                        animationSpeed={5.1}
                ...
                <Card
                    title="Custom tools for your unique needs"
                    icon={<AceternityIcon />}
                >
                    <CanvasRevealEffect
                        animationSpeed={3}
                ...
                <Card
                    title="Build Multi-Agent Workflows with Ease"
                    icon={<AceternityIcon />}
                >
                    <CanvasRevealEffect
                        animationSpeed={3}
